...
- [X] Cochez cette checkbox en plaçant un "**X**" entre les deux `[X]` en début de ligne.
...
- [X] final Depuis le site Github (le dépôt "distant"), utiliser le bouton éditer ✏ pour cocher cette case. Avec "édit depuis Github", comme message de commit.
